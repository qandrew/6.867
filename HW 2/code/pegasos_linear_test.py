...
def predict_linearSVM(x):
	return w[0]*x[0] + w[1]*x[1] + w[2] # + w0 #w0 is the bias

# plot training results
print '======PLOTTING======'
plotDecisionBoundary(X, Y, predict_linearSVM, [-1,0,1], title = 'Linear SVM lambda = 2^'+str(power))
pl.show()
